...
function Objectives() {
  return (
    <section className="container mx-auto p-10">
      ...
      <h2 className="text-3xl font-bold">My Objectives</h2>
      ...
      <a href="https://drive.google.com/file/d/1B_bN3RvoskG59Pd6w5fr4EPRaVOnAnX7/view?usp=sharing" download class="download-btn">
